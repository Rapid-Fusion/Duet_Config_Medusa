...
G4 S4                                                                   ; wait for expansion boards to boot up
...
; TEMP
M308 S0 Y"mcu-temp" A"Top"
M308 S1 Y"mcu-temp" A"Middle"
M308 S2 Y"mcu-temp" A"Bottom"
M308 S3 Y"mcu-temp" A"Nozzle"

M950 H0 C"out3" T0                                                      ; create Top heater output and map it to sensor 0
M950 H1 C"out4" T1                                                      ; create Top heater output and map it to sensor 1
M950 H2 C"out5" T2                                                      ; create Top heater output and map it to sensor 2
M950 H3 C"out6" T3                                                      ; create Top heater output and map it to sensor 3
...
M584 E0.3:6.0:3.0:3.1:6.1:3.2:3.3                                       ; set extruder mapping
...
M92 E300.075:678.5589:471.7822:471.7822:378.18:471.7822:471.7822        ; configure steps per mm -- 582/0.8577=678.5589 (DyzeXtruder Pro); (476.5/1.01=471.7822 (1.75mm)- bondtech) 
...
;M591 D2.3 P7 C"6.io0.in" S2 R50:150 L0.156 E0.8 ; [HARD FILAMENT] Slower filament presence detection, higher sensitivity for jam detection
;M591 D2.3 P7 C"6.io1.in" S2 R85:115 L0.156 E9.4 ; [SOFT FILAMENT] Slower filament presence detection, higher sensitivity for jam detection
...
M950 P3 C"1.out2"                                                       ; Pellet Feed -- Extruder (ENABLE/DISABLE)
...
M567 P3 E1:1:1                                                          ; set tool #3 filament extruder mixing ratios (Zephyr:bondtech1:bondtech2)
...
G10 L1 P3 X60 Y-230 Z{global.filament_RIGHT_offset}                     ; Filament RIGHT
...
M568 P3 A0                                                              ; set tool heater to off
...
M98 P"solenoid_lock.g"                                                  ; Lock tool on startup
