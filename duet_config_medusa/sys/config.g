...
M570 H2 P300 T100                                                       ; An anomaly on heaters 2 must persist for 300 seconds, and must be greater or less than 50C from the setpoint, to raise a heater fault.
...
M567 P3 E1:0.968:0.968                                                  ; set tool #3 filament extruder mixing ratios (Zephyr:bondtech1:bondtech2)
