...
if !exists(global.filament_LEFT_offset)
	global filament_LEFT_offset = -9.6
else
	set global.filament_LEFT_offset = -9.6
...
; Duet Suggested Params (Tweaking out in the Z)
;M569 P0.0 S0 R1 T0.75:0.75:1:1                                          ; driver 0.0 goes forwards and requires an active-high enable signal (X axis)
;M569 P0.1 S1 R1 T0.75:0.75:1:1                                          ; driver 0.1 goes forwards and requires an active-high enable signal (Y axis)
;M569 P0.2 S1 R1 T0.75:0.75:1:1                                          ; driver 0.2 goes forwards and requires an active-high enable signal (Y axis)
;M569 P0.3 S0 R1 T0.75:0.75:1:1                                          ; driver 0.3 goes forwards and requires an active-high enable signal (Z axis)

; Axes
M584 X0.0 Y0.1:0.2 Z0.3                                                 ; set axis mapping
;M92 X85.3333 Y85.3333 Z160                                              ; configure steps per mm - 1/steps to find resolution
M92 X100 Y100 Z160                                                      ; configure steps per mm - 1/steps to find resolution - Siemens Motion System
...
M566 X480 Y480 Z240                                                     ; set maximum instantaneous speed changes (mm/min) -- Default X480 Y480 Z120
...
M569 P3.2 S1 D2 T3:3:5:0                                                ; driver 3.2 goes forwards (filament feeder BONDTECH RIGHT)
...
;M92 E300.075:274.0:462.903:274.0:462.903                                ; configure steps per mm (492.45*0.94 = 462.903) - mixing ratio (492.45 (2.75mm) - bontech)
;M92 E300.075:582:476.5:582:476.5                                        ; configure steps per mm -- 582 (DyzeXtruder Pro); (476.5 (1.75mm)- bondtech) 
M92 E300.075:678.5589:471.7822:678.5589:471.7822                        ; configure steps per mm -- 582/0.8577=678.5589 (DyzeXtruder Pro); (476.5/1.01=471.7822 (1.75mm)- bondtech) 
...
M308 S6 P"6.spi.cs1" Y"rtd-max31865" A"Nozzle"                          ; configure sensor
...
M950 H6 C"6.out1" T6                                                    ; create Middle heater output and map it to sensor 6
...
;M307 H6 A580.4 C256.6 D6.4 S0.50 B0                                     ; Default -- Heating process parameters for a 24V system
;M307 H6 R2.652 K0.176:0.000 D8.39 E1.35 S0.50 B0                        ; Filament LEFT - tuned to 300 deg
M307 H6 R2.652 K0.176:0.000 D8.39 E1.35 S1 B0                           ; Filament LEFT - tuned to 300 deg with Cooling Fan at 75%
...
M143 H6 S493                                                            ; set temperature limit for heater 0 to 493C

M143 H7 S450                                                            ; set temperature limit for heater 0 to 450C
M143 H8 S450                                                            ; set temperature limit for heater 0 to 450C

; Extruder heater fault detection
;M570 H5 P120 T60                                                        ; An anomaly on heaters 2 must persist for 120 seconds, and must be greater or less than 30C from the setpoint, to raise a heater fault.
M570 H6 P120 T60                                                        ; An anomaly on heaters 3 must persist for 120 seconds, and must be greater or less than 30C from the setpoint, to raise a heater fault.
M570 H7 P120 T60                                                        ; An anomaly on heaters 4 must persist for 120 seconds, and must be greater or less than 30C from the setpoint, to raise a heater fault.
M570 H8 P120 T60                                                        ; An anomaly on heaters 5 must persist for 120 seconds, and must be greater or less than 30C from the setpoint, to raise a heater fault.
...
M591 D1 P7 C"6.io0.in" S2 R50:150 L1.246 E5.2                           ; [Bondtech LEFT -- HARD FILAMENT] Slower filament presence detection, higher sensitivity for jam detection
;M591 D3 P7 C"6.io1.in" S2 R50:150 L1.246 E5.2                           ; [Bondtech RIGHT -- HARD FILAMENT] Slower filament presence detection, higher sensitivity for jam detection
...
; SuperPINDA probe (PRUSA) - temp independnt inductive probe - improved first layer accuracy
; Probe by extending A/B-axis
; configure SuperPINDA as probe 2, Dive height (H) -- height above the trigger height from which probing starts, type 5 (normally closed)
; Maximum number of times to probe each point (A), first:second:third probing feed rate (F), travel speed to & between probe points(T)
M558 K2 P8 C"6.io2.in" H1.5 F72 T720                                    ; SuperPINDA on LEFT extruder
G31 K2 X0 Y0 Z0.55                                                      ; 0.2mm trigger height (0.7mm standard)
...
M307 H4 R0.400 K0.291:0.000 D8.27 E1.35 S1.00 B0                        ; Bed PID tuning parameters - No Fixture Plate
...
;G31 P11430 K0 X0 Y0 Z6 T0.0265 S22.2 H10                                ; T = mm/degC reduction in trigger height
...
; ------------------------------------------------------- Humidity, Temp & Pressure Sensors (BME280) -----------------------------------------------------

;BME Sensor
;M308 S11 Y"bme280" P"2.spi.cs1" A"Print Chamber temp"
;M308 S12 Y"bme-pressure" P"2.S11.1" A"Print Chamber Pressure[hPa]"
;M308 S13 Y"bme-humidity" P"2.S11.2" A"Print Chamber Humidity[%]"

;M308 S14 Y"bme280" P"4.spi.cs1" A"Pel Dryer temp"
;M308 S15 Y"bme-pressure" P"4.S14.1" A"Pel Dryer Pressure[hPa]"
;M308 S16 Y"bme-humidity" P"4.S14.2" A"Pel Dryer Humidity[%]"

M308 S17 Y"bme280" P"3.spi.cs0" A"Fil Chamber temp"
M308 S18 Y"bme-pressure" P"3.S17.1" A"Fil Chamber Pressure[hPa]"
M308 S19 Y"bme-humidity" P"3.S17.2" A"Fil Chamber Humidity[%]"

M308 S20 Y"bme280" P"1.spi.cs1" A"Main Cab temp"
M308 S21 Y"bme-pressure" P"1.S20.1" A"Main Cab Pressure[hPa]"
M308 S22 Y"bme-humidity" P"1.S20.2" A"Main Cab Humidity[%]"

;M308 S23 Y"bme280" P"4.spi.cs2" A"Pel Cab temp"
;M308 S24 Y"bme-pressure" P"4.S23.1" A"Pel Cab Pressure[hPa]"
;M308 S25 Y"bme-humidity" P"4.S23.2" A"Pel Cab Humidity[%]"
...
M950 P10 C"3.out5"                                                      ; filament insert LEFT Button (TRUE=WH, FALSE=GR)
M950 P11 C"3.out4"                                                      ; filament retract LEFT Button (TRUE=WH, FALSE=GR)
...
M950 P21 C"4.out8"                                                      ; Spindle Swarf Suction

M950 P22 C"6.out2"                                                      ; Filament LEFT Heatsink Fan
...
M950 J21 C"!2.io4.in"                                                   ; VFD Spindle Feedback (0 = ERROR, 1 = READY) IO to be verified
...
;581 T4 P15 S0 R0                                                       ; invoke trigger 4 when an active-to-inactive edge is detected on input 15
...
;M563 P2 D1:2:4 H5:6 F7 S"Filament Extruder LEFT" L1                     ; create tool #2 (filament LEFT) using extruder drive [Typhoon] & feeder drive [Bondtech]

M563 P2 D1:2:4 H6 F7 S"Filament Extruder LEFT" L1                       ; create tool #2 (filament LEFT) using extruder drive [Typhoon] & feeder drive [Bondtech]
M563 P3 D3 H7:8 F7 S"Filament Extruder RIGHT" L3                        ; create tool #3 (filament RIGHT) using extruder drive [Typhoon] & feeder drive [Bondtech]
...
M567 P2 E1:1:1                                                          ; set tool #2 filament extruder mixing ratios (dyze:bondtech)
M567 P3 E1                                                              ; set tool #3 filament extruder mixing ratios (dyze:bondtech)
...
; Tools
M98 P"toolstartup.g"
M42 P22 S1                                                              ; Filament LEFT heatsink fan always on
...
;M906 E0:3200:1200:3200:1200                                             ; set extruder driver currents (dyze typhoon)
M906 E0:1270:1200:1270:1200                                             ; set extruder driver currents (DyzeXtruder Pro)
...
M200 D10.95:1.75:1.75:1.75:1.75 S0                                      ; Set filament diameter -- Pel:FilL:FilL:FilR:FilR

; -------------------------------------------------------------------------- System Outputs ------------------------------------------------------------------------

; Enable Filament Loading/Unloading on Boot
...
;M581 T6 P19 S0 R0                                                       ; Door Button Trigger - invoke trigger 6 when an active-to-inactive edge is detected on input 19
